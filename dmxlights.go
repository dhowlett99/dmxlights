...
func main() {
	...
	this.MasterBrightness = make([]int, numberOfSequences+NumberOfSwitches) // Affects selected sequences DMX fixtures and launchpad lamps.
	...
	buttons.InitButtons(&this, sequences[0].SequenceColors, eventsForLaunchpad, guiButtons)
