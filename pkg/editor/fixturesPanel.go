...
func NewFixturePanel(sequences []*common.Sequence, w fyne.Window, group int, number int, commandChannels []chan common.Command) (popupFixturePanel *widget.PopUp, err error) {
