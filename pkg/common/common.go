...
func newColorPicker() []ColorPicker {
	...
	colors := []ColorPicker{
		...
		{ID: 4, X: 4, Y: 0, Name: "Cyan", Code: 0x24, Color: Color{R: 0, G: 255, B: 255}},
		{ID: 5, X: 5, Y: 0, Name: "Blue", Code: 0x4f, Color: Color{R: 0, G: 0, B: 255}},      // Launchpad code checked.
		{ID: 6, X: 6, Y: 0, Name: "Purple", Code: 0x51, Color: Color{R: 100, G: 0, B: 255}},  // Launchpad code checked.
		...
		{ID: 14, X: 6, Y: 1, Name: "Purple", Code: 0x35, Color: Color{R: 138, G: 43, B: 226}},
		...
		{ID: 22, X: 6, Y: 2, Name: "Violet", Code: 0x51, Color: Color{R: 199, G: 21, B: 133}},
